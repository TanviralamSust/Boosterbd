					...
					<div class="col-sm-12">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="home" role="tabpanel">
								...
								<img src="images/Logo/booster_logo.png" style="max-height: 100%; max-width: 100%;">
								...
								<img src="images/Logo/booster_logo.png" style="max-height: 100%; max-width: 100%; background: center;">
      ...
      <form action="{{url('/addUpdates')}}">
        ...
        <div class="form-group">
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
                                <input class="form-control"  placeholder="New Update" id="updateTitle" name="updateTitle">
            </div>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="form-group row">
            ...
            <div class="col-9">
                                <textarea id="updateDesc" name="updateDesc" class="form-control form-control-lg" rows="3"></textarea>
        ...
        <div class="form-group row">
                                <div class="col-9 col-md-10">
                                        <a href="{{url('/addUpdates')}}" type="submit" class="btn btn-primary" style="float: right;">Add update</a>
                                </div>
                            </div>
							...
							<div class="tab-pane" id="comments" role="tabpanel">
								<ul class="comment-section mt-0">
									...
									<li class="write-new">
										...
										<form action="{{url('/addComments')}}" method="post">

											<textarea id="addComment" name="addComment" placeholder="Write your comment here" name="comment"></textarea>
				...
				<div class="card-block" class="pb-1" >
					<div class="row ">
						<div class="col-sm-12">
							...
							<div class="row ">
								<div class="col-sm-5">
									<a onclick="event.preventDefault(); document.getElementById('id01').style.display='block';document.getElementById('id01').style.overflow='auto'"  class="nav-link" href=""><img src="images/team/pixeliris.jpg" class="img-fluid rounded-circle" /></a>
									<br />
									<br />
								</div>
								<div class="col-sm-6">
							...
							<a href="" onclick="event.preventDefault(); document.getElementById('transDiv').style.display='block';document.getElementById('transDiv').style.overflow='auto'" class="btn btn-lg btn-primary btn-block">Back this project</a><br />
