				...
				<div class="card-block" class="pb-1" >
					<div class="row ">
						<div class="col-sm-12">
							...
							<div class="row ">
								<div class="col-sm-5">
									<a onclick="event.preventDefault(); document.getElementById('id01').style.display='block';document.getElementById('id01').style.overflow='auto'"  class="nav-link" href="">
										...
										@else
										<img src="{{DB::table('users')->select('id','first_name','last_name','picture','biography','location','website','contact')->where(['user_id'=>Auth::user()->id])->get()[0]->picture}}" class="img-fluid rounded-circle" />
										@endif
									</a>
									<br />
									<br />
								...
								<div class="col-sm-6">
									...
									<p class="mt-0 mb-0">{{$count = DB::table('projects')->select('id')->where(['user_id'=>$user[0]->id])->get()->count()}} Project</p>
									<br />
									<br />
								</div>
							...
							<p>This project will only be funded if at least ${{$project[0]->goal}} is pledged by Wednesday May 8, 3:00pm</p>
