...
<div class="row" style="height: 200px; padding-top: 7%;">
<div class="btn-group  btn-block" style="width: 40%; height: 25%">
        <button class="btn btn-secondary btn-lg  btn-block dropdown-toggle text-center" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="vertical-align: center; float: top;">
        <span id="selected" class="caret" style="vertical-align: center; padding-bottom: 100px;">Account Type</span></button>
        <div class="dropdown-menu" style="width: 100%">
        
          
            <a class="dropdown-item" onclick="event.preventDefault()" href="{{url('/explore/Android')}}">Master Card</a>
          
            <a class="dropdown-item" onclick="event.preventDefault()" href="{{url('/explore/Website')}}">Visa Card</a>
      ...
      <input class="form-control" type="submit" placeholder="Account number" type="email" value="" name="account" id="account" style="width:100%; ">
      </div>
      <div>
        <div class="col-sm-4 text-center">
                                    <a href="{{url('/account-payment/addCard')}}" onclick="event.preventDefault();" class="btn btn-primary">Add card</a>
                                </div>
      </div>
    </div>
    </form>
